...
/*==============================ä»¥ä¸Šéƒ¨åˆ†ä¸ºheatmap.jsçš„æ ¸å¿ƒä»£ç ,åªè´Ÿè´£çƒ­åŠ›å›¾çš„å±•çŽ°====================================*/


/*==============================ä»¥ä¸‹éƒ¨åˆ†ä¸ºä¸“ä¸ºç™¾åº¦åœ°å›¾æ‰“é€ çš„è¦†ç›–ç‰©===================================================*/
/**
 * @fileoverview ç™¾åº¦åœ°å›¾çš„çƒ­åŠ›å›¾åŠŸèƒ½,å¯¹å¤–å¼€æ”¾ã€‚
 * ä¸»è¦åŸºäºŽhttp://www.patrick-wied.at/static/heatmapjs/index.html ä¿®æ”¹è€Œå¾—
 
 * ä¸»å…¥å£ç±»æ˜¯<a href="symbols/BMapLib.Heatmap.html">Heatmap</a>ï¼Œ
 * åŸºäºŽBaidu Map API 2.0ã€‚
 *
...
(function() {
    ...
    /**
     * çƒ­åŠ›å›¾çš„è¦†ç›–ç‰©
     * @class çƒ­åŠ›å›¾çš„è¦†ç›–ç‰©
     * å®žä¾‹åŒ–è¯¥ç±»åŽï¼Œä½¿ç”¨map.addOverlayå³å¯ä»¥æ·»åŠ çƒ­åŠ›å›¾
     * 
     * @constructor
     * @param {Json Object} opts å¯é€‰çš„è¾“å…¥å‚æ•°ï¼Œéžå¿…å¡«é¡¹ã€‚å¯è¾“å…¥é€‰é¡¹åŒ…æ‹¬ï¼š<br />
     * {"<b>radius</b>" : {String} çƒ­åŠ›å›¾çš„åŠå¾„,
     * <br />"<b>visible</b>" : {Number} çƒ­åŠ›å›¾æ˜¯å¦æ˜¾ç¤º,
     * <br />"<b>gradient</b>" : {JSON} çƒ­åŠ›å›¾çš„æ¸å˜åŒºé—´,
     * <br />"<b>opacity</b>" : {Number} çƒ­åŠ›çš„é€æ˜Žåº¦,
     *
     * @example <b>å‚è€ƒç¤ºä¾‹ï¼š</b><br />
     * var map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br />var heatmapOverlay = new BMapLib.HeatmapOverlay({"radius":10, "visible":true, "opacity":70});<br />heatmapOverlay.setDataSet(data);//dataæ˜¯çƒ­åŠ›å›¾çš„è¯¦ç»†æ•°æ®
     */
    ...
    HeatmapOverlay.prototype.initialize = function(map) {
        ...
        if(!isSupportCanvas()){//åˆ¤æ–­æ˜¯å¦æ”¯æŒCanvas.
            return el;
        }
    ...
    /**
     * è®¾ç½®çƒ­åŠ›å›¾å±•çŽ°çš„è¯¦ç»†æ•°æ®, å®žçŽ°ä¹‹åŽ,å³å¯ä»¥ç«‹åˆ»å±•çŽ° 
     * @param {Json Object } data
     * {"<b>max</b>" : {Number} æƒé‡çš„æœ€å¤§å€¼,
     * <br />"<b>data</b>" : {Array} åæ ‡è¯¦ç»†æ•°æ®,æ ¼å¼å¦‚ä¸‹ <br/>
     * {"lng":116.421969,"lat":39.913527,"count":3}, å…¶ä¸­<br/>
     * lng latåˆ†åˆ«ä¸ºç»çº¬åº¦, countæƒé‡å€¼
     */
    ...
    /**
     * æ·»åŠ çƒ­åŠ›å›¾çš„è¯¦ç»†åæ ‡ç‚¹
     * @param {Number} lng ç»åº¦åæ ‡
     * @param {Number} lat çº¬åº¦åæ ‡
     * @param {Number} count æƒé‡
     */
    ...
    /**
     * è®¾ç½®çƒ­åŠ›å›¾å±•çŽ°çš„é…ç½®
     * @param {Json Object} options å¯é€‰çš„è¾“å…¥å‚æ•°ï¼Œéžå¿…å¡«é¡¹ã€‚å¯è¾“å…¥é€‰é¡¹åŒ…æ‹¬ï¼š<br />
     * {"<b>radius</b>" : {String} çƒ­åŠ›å›¾çš„åŠå¾„,
     * <br />"<b>visible</b>" : {Number} çƒ­åŠ›å›¾æ˜¯å¦æ˜¾ç¤º,
     * <br />"<b>gradient</b>" : {JSON} çƒ­åŠ›å›¾çš„æ¸å˜åŒºé—´,
     * <br />"<b>opacity</b>" : {Number} çƒ­åŠ›çš„é€æ˜Žåº¦,}
    ...
    HeatmapOverlay.prototype.setOptions = function(options){
        ...
        if(this.data){
            this.setDataSet(this.data);//é‡æ–°æ¸²æŸ“
        }
    }
